...
import { BrainCircuit, ArrowRight, Loader2, Sparkles, ShieldCheck, AlertCircle } from 'lucide-react';
...
export default function AIReframeStudio({ onComplete }: Props) {
  ...
  const instructions = (
    <div className="space-y-4">
      <p>
        Welcome to the <strong>AI Reframe Studio</strong>.
      </p>
      <p>
        The goal of this tool is to help you take unstructured, difficult thoughts and identify the specific cognitive distortions driving them. By labeling these distortions, the AI will guide you to create a more balanced, realistic perspective.
      </p>
      <p>
        <strong>How to play:</strong>
      </p>
      <ul className="list-disc pl-5">
        <li>Type a thought that is bothering you.</li>
        <li>Rate your current distress level.</li>
        <li>Let the AI analyze the thought for distortions.</li>
        <li>Follow the guiding questions to write a new "reframed" thought.</li>
      </ul>
    </div>
  );
  ...
  const referenceContent = (
    <div className="space-y-4">
      ...
      <ul className="list-disc pl-5 space-y-2">
        <li><strong>All-or-Nothing Thinking:</strong> Thinking in black and white terms.</li>
        <li><strong>Catastrophizing:</strong> Expecting the worst possible scenario.</li>
        <li><strong>Mind Reading:</strong> Assuming you know what others are thinking.</li>
        <li><strong>Emotional Reasoning:</strong> Believing what you feel must be true.</li>
        <li><strong>Should Statements:</strong> Having rigid rules for yourself or others.</li>
        <li><strong>Personalization:</strong> Blaming yourself for things outside your control.</li>
      </ul>
    </div>
  );
  ...
  return (
    <GameLayout
      ...
      referenceTitle="Cognitive Distortions"
